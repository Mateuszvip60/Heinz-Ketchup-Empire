...
import { computeStats, calculateClickPower, buyUpgrade, estimateRebirth } from "./core/calculations.js";
...
function onAchievementUnlock(id) {
    const playAudio = state.totalLifetimeDrops >= 100000;
    showAchievementPopup(translate(`${id}Title`), translate(`${id}Desc`), { playAudio });
}
