...
import { showAchievementPopup, playSound, hideLoadingScreen } from "./ui/effects.js";
import { elements } from "./ui/elements.js";
import { showLeaderboard, showUpgrades } from "./ui/tabs.js";
...
function initUI() {
    ...
    // Setup upgrade tabs
    const regularTab = document.getElementById("regularUpgradesTab");
    const soulTab = document.getElementById("soulUpgradesTab");
    const regularContainer = document.getElementById("upgradesContainer");
    const soulContainer = document.getElementById("soulUpgradesContainer");
    
    if (regularTab && soulTab && regularContainer && soulContainer) {
        regularTab.addEventListener("click", () => {
            regularTab.classList.add("active");
            soulTab.classList.remove("active");
            regularContainer.style.display = "block";
            soulContainer.style.display = "none";
        });
        
        soulTab.addEventListener("click", () => {
            soulTab.classList.add("active");
            regularTab.classList.remove("active");
            regularContainer.style.display = "none";
            soulContainer.style.display = "block";
        });
    }
